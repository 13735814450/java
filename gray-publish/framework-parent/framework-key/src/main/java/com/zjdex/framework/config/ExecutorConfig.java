...
public class ExecutorConfig {
    ...
    public ScheduledExecutorService scheduledExecutorService() {
        ...
        ThreadFactory threadFactory = (new ThreadFactoryBuilder()).setNameFormat("scheduled-thread-pool-%d").build();
        return new ScheduledThreadPoolExecutor(corePoolSize, threadFactory, new AbortPolicy());
    }
}
